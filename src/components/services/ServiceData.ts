...
export const serviceDetails: ServiceDetails[] = [
  {
    ...
    fullDescription: [
      ...
      "Наш опыт в различных отраслях позволяет нам обеспечивать безупречное выполнение проектов с минимальными влиянием на уже действующие производственные процессы для исключения или минимизации перебоев в деятельности Вашего бизнеса.",
  ...
  },
  {
    ...
    fullDescription: [
      "Перемещение промышленного оборудования требует точности, высокого уровня экспертизы и тщательного планирования. Наши комплексные услуги по перемещению оборудования обеспечивают минимальное время простоя и максимальную эффективность, независимо от того, перемещаете ли вы один станок или целое предприятие."
    ],
    benefits: [
