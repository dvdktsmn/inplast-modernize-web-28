...
export const featuredProjectsData: FeaturedProject[] = [
  ...
  },
  {
    ...
    location: "Европа",
    description: "Проект включал комплексную модернизацию производственной линии для повышения операционной эффективности, улучшения управления процессами и продления срока службы оборудования. Модернизация охватывала ключевые компоненты по всей линии, включая дозирование, экструзию, каст-формирующую машину, MDO, TDO, PRS, намотчик и первичную резку. Улучшения включали новую автоматизацию верхнего уровня на базе Siemens STEP 7 и TIA Portal, модернизированные «полевые» системы управления, новые электрические шкафы, улучшенное тепловое и пневматическое управление, а также интеграцию передовых измерительных технологий. Модернизация была направлена на повышение операционной эффективности, обеспечение надежного управления процессами и продление срока службы оборудования, что позволило достичь более высокой производительности и получить возможности для будущей масштабируемости.",
    images: [
