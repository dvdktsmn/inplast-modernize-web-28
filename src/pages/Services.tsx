  ...
  const serviceCategories = [
    {
      ...
      description: "Мы выполняем капитальный ремонт и модернизацию оборудования для увеличения его долговечности, энергетической и операционной эффективности, приводя устаревшие системы в соответствие с современными стандартами.",
      images: [
    ...
    },
    {
      ...
      description: "От проектирования до внедрения, наши решения электротехнического инжиниринга и реализации систем автоматического управления поддерживают безопасное, интеллектуальное и масштабируемое управление производственной средой, повышая ее эффективность и сокращая потери.",
      images: [
    ...
    },
    {
      ...
      description: "Обеспечьте безупречную работу с первого дня. Наши эксперты управляют процессом установки и ввода в эксплуатацию оборудования, предлагая как локальную техническую и технологическую поддержку, так и международный опыт с возможностью удалённой поддержки.",
      images: [
